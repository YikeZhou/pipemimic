...
object Gem5FixedTest {
  ...
  /**
    ...
    */
  def Gem5FixedO3PipelineStages(n: Int, c: Int): List[Stage] = {
    List(
  ...
  val Gem5FixedO3MemoryHierarchyStages = List(
    Stage("L2CacheForWrites", NoOrderGuarantees, NoSpecialEdges),
    Stage("Retire", NoOrderGuarantees, NoSpecialEdges),
  )

  def Gem5FixedO3AllStages(n: Int): List[Stage] = {
    List.tabulate(n)(Gem5FixedO3PipelineStages(n, _)).flatten ::: Gem5FixedO3MemoryHierarchyStages
  }
  ...
  /** Pipeline Paths */
  def Gem5FixedO3PathOptions(n: Int, e: Event): List[PathOption] = {
    val c = e.iiid.proc
    e.dirn match {
